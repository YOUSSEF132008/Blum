...
class blum:
    ...
    def __init__(self):
        self.query_list = self.load_query("JOO.txt")
        self.token = None
    ...
    def banner(self) -> None:
        ...
        self.log("SCRIPT SHARE BY :(https://t.me/kingelnet)", Fore.CYAN)
    ...
    def load_query(self, path_file: str = "JOO.txt") -> list:
        """
        Loads a list of queries from the specified file.

        Args:
            path_file (str): The path to the query file. Defaults to "JOO.txt".
...
async def main():
    ...
    blu.log(" === BILAL STUDIO === ", Fore.YELLOW)
